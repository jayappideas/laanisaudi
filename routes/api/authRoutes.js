...
router.post('/user/forgotPassword', upload.none(), authController.forgotPassword);
...
router.post('/vendor/addBusinessInfo', authController.isVendor, upload.fields([
                                    { name: 'businessLogo', maxCount: 1 },
                                    { name: 'businessLicense', maxCount: 1 }
                                    ]), authController.addBusinessInfo);
router.post('/vendor/addBusinessMenu', authController.isVendor, upload.fields([
...
router.put('/vendor/updateBusinessInfo', authController.checkVendor, upload.fields([
                                    { name: 'businessLogo', maxCount: 1 },
                                    { name: 'businessLicense', maxCount: 1 }
                                    ]), authController.updateBusinessInfo);

router.post('/vendor/addSingleMenu', authController.checkVendor, upload.single('image'), authController.addSingleMenu);
router.delete('/vendor/deleteMenu/:image', authController.checkVendor, upload.none(), authController.deleteMenu);

router.post('/vendor/changePassword', authController.checkVendor, upload.none(), authController.changePasswordVendor);
router.post('/vendor/updateNotification/:status', authController.checkVendor, upload.none(), authController.updateNotificationVendor);
router.delete('/vendor/deleteAccount', authController.checkVendor, upload.none(), authController.deleteAccountVendor);
