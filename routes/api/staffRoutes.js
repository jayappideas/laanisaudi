...
router.put('/update/:id',  checkVendor, upload.none(), staffController.updateStaff);
router.delete('/delete/:id',  checkVendor, upload.none(), staffController.deleteStaff);

router.post('/login', upload.none(), staffController.login);
router.post('/updateNotification/:status', staffController.checkStaff, upload.none(), staffController.updateNotification);
